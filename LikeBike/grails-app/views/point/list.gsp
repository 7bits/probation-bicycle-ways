...
<body>
<a href="#list-point" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="latitude"
                              title="${message(code: 'point.latitude.label', default: 'Latitude')}"/>

            <g:sortableColumn property="longitude"
                              title="${message(code: 'point.longitude.label', default: 'Longitude')}"/>

            <g:sortableColumn property="routeIndex"
                              title="${message(code: 'point.routeIndex.label', default: 'Route Index')}"/>
        ...
        <g:each in="${pointInstanceList}" status="i" var="pointInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${pointInstance.id}">${fieldValue(bean: pointInstance, field: "latitude")}</g:link></td>
