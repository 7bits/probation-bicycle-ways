        ...
        <g:form action='userSearch' name='userSearchForm'>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan='3'><g:textField name='username' size='50' maxlength='255' autocomplete='off'
                                                 value='${username}'/></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <g:radioGroup name='accountExpired' labels="['', '', '']" values="[1, -1, 0]"
                ...
                <tr>
                    ...
                    <g:radioGroup name='accountLocked' labels="['', '', '']" values="[1, -1, 0]"
                                  value='${accountLocked}'>
                        <td><%=it.radio%></td>
                    </g:radioGroup>
                </tr>
                <tr>
                    ...
                    <g:radioGroup name='passwordExpired' labels="['', '', '']" values="[1, -1, 0]"
                ...
                <tr>
                    <td colspan='4'><s2ui:submitButton elementId='search' form='userSearchForm'
